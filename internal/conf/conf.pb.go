...
type Bootstrap struct {
	...
	Llm           *LLM                   `protobuf:"bytes,4,opt,name=llm,proto3" json:"llm,omitempty"`
...
type Data_Redis struct {
	...
	WarnLimit     int64                  `protobuf:"varint,4,opt,name=warn_limit,json=warnLimit,proto3" json:"warn_limit,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data_Redis) GetPw() string {
	if x != nil {
		return x.Pw
	}
	return ""
...
func (x *Data_Redis) GetWarnLimit() int64 {
	if x != nil {
		return x.WarnLimit
	}
	return 0
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x03llm\x18\x04 \x01(\v2\x0f.kratos.api.LLMR\x03llm\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\x06source\x18\x02 \x01(\tR\x06source\x1aZ\n" +
	"\x05Redis\x12\x12\n" +
	...
	"\bapi_base\x18\x03 \x01(\tR\aapiBaseB\x1dZ\x1bedustate/internal/conf;confb\x06proto3"
